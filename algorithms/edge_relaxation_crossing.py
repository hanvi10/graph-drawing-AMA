"""
algorithms/edge_relaxation_crossing.py
=======================================
Crossing Participation Count.

Each edge is scored by how many crossings it is directly involved in
after the initial layout, rather than by Edge Betweenness Centrality.
This is directly aligned with the optimization objective.
"""
...
def _crossing_participation(edges, pos) -> dict:
    """Count how many crossings each edge participates in."""
...
class EdgeRelaxationCrossing(GraphDrawingAlgorithm):
    """
    Edge Relaxation using Crossing Participation Count as edge score (A1).
    """
    ...
    @property
    def name(self) -> str:
        return f"edge_relaxation_crossing(kr={self.k_r},kw={self.k_w})"
